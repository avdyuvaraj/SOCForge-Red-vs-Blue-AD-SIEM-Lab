...
1. Generate attack activity
2. Collect logs from endpoints
3. Forward logs to Wazuh Manager
4. Analyze events using Wazuh Dashboard
5. Detect suspicious activities
6. Trigger alerts through custom rules
7. Investigate incidents
8. Document findings and responses
